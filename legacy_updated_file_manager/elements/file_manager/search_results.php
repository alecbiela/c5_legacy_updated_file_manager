...
$bu = $uh->getToolsURL('/files/search_results', 'legacy_updated_file_manager');
...
<div id="ccm-<?php echo $searchInstance?>-search-results" class="ccm-file-list">
	...
	<div id="ccm-list-wrapper"><a name="ccm-<?php echo $searchInstance?>-list-wrapper-anchor"></a>
		...
		<div style="float: right">
			<?php Loader::element('file_manager/upload_single', array('searchInstance' => $searchInstance, 'ocID' => $ocID), 'legacy_updated_file_manager'); ?>
		</div>
