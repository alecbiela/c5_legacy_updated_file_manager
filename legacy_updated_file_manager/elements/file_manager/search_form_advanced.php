...
?>	
	...
	<form method="get" class="form-horizontal" id="ccm-<?php echo $searchInstance?>-advanced-search" action="<?= $uh->getToolsURL('files/search_results', 'legacy_updated_file_manager'); ?>">
