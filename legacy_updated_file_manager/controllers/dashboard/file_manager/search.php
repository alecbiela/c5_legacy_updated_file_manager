...
class DashboardFileManagerSearchController extends Controller {
	...
	public function view() {
		...
		// $this->addHeaderItem($html->javascript('bootstrap.min.js', 'legacy_updated_file_manager'));
		// $this->addHeaderItem($html->javascript('dropzone.min.js', 'legacy_updated_file_manager'));
		// $this->addHeaderItem($html->css('dropzone.min.css', 'legacy_updated_file_manager'));
		// $this->addHeaderItem($html->css('bootstrap.modals.css', 'legacy_updated_file_manager'));
		// $this->addHeaderItem($html->css('dropzone-custom.css', 'legacy_updated_file_manager'));
