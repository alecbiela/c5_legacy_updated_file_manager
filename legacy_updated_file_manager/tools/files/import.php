		...
		<div class="tab-content">
				...
				<script type="text/javascript">
					$(function() { 
						...
						var dz = new Dropzone("div#dz_upload_multiple", {
							url: "<?= $uh->getToolsURL('files/importers/dropzone', 'legacy_updated_file_manager'); ?>",
							maxFilesize: "<?= $umf; ?>",
							maxFiles: 100,
							thumbnailWidth: 110,
							thumbnailHeight: 110,
			...
			<div id="ccm-file-add-incoming" class="tab-pane">
				...
				<?php if(!empty($incoming_contents)) { ?>
					<form style="margin: 0;" id="ccm-file-manager-multiple-incoming" method="post" action="<?= $uh->getToolsURL('files/importers/incoming_ajax', 'legacy_updated_file_manager'); ?>">
			...
			<div id="ccm-file-add-remote" class="tab-pane">
				...
				<form method="POST" id="ccm-file-manager-multiple-remote" action="<?= $uh->getToolsURL('files/importers/remote_ajax', 'legacy_updated_file_manager'); ?>">
					<input type="hidden" name="searchInstance" value="<?= $searchInstance; ?>" />
					<input type="hidden" name="ocID" value="<?= $ocID; ?>" />
